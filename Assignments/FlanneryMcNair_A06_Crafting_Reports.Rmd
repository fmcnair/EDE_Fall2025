...
```{r project.setup, warning=FALSE, message=FALSE}
#Import libraries
library(tidyverse)
library(lubridate)
library(here)
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.align='left', fig.height=3.5, fig.width=7, fig.cap="2018 Monthly Ozone Levels"}
...
plot_2018 <- data_2018 %>% 
  ...
  geom_boxplot() +
  ggtitle("Monthly Ozone Concentration (2018)")+
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.align='left', fig.height=3.5, fig.width=7, fig.cap="2019 Monthly Ozone Levels"}
data_2019 <- epa_data %>%
  filter(Year == 2019)
...
plot_2019 <- data_2019 %>% 
  ...
  geom_boxplot() +
  ggtitle("Monthly Ozone Concentration (2019)")+
  labs(x = "Month", y = 'Concentration (ug/m^3)')
...
https://github.com/fmcnair/EDE_Fall2025
